...
Workflow
Ultrasound Image → Preprocessing → U-Net++ / SUNet Segmentation → CNN Classification Model → Diagnosis Output → Domain-Aware Clinical Guidance
---
...
Epochs & LR: 50 epochs, learning rate = 1e-4
---
